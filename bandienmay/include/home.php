		...
		<h3 class="tittle-w3l text-center mb-lg-5 mb-sm-4 mb-3">
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						?>
							...
							<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
								...
								<div class="row">
									<?php
									$sql_product = mysqli_query($con, "SELECT * FROM tbl_sanpham where category_id=" . $row_cate_home['category_id'] . " ORDER BY sanpham_id DESC LIMIT $tung_trang,$sp_tungtrang");
					...
					<nav aria-label="..." style="display:flex;justify-content: center;clear:both">
						<?php
						...
						for ($i = 1; $i <= $product_button; $i++) {
							...
							echo '<ul class="pagination">
							  <li class="page-item active">
								<a class="page-link" href="index.php?trang='.$i.'">'.$i.'  
